...
| **M2B** — Tenancy model & capabilities        | restaurants, memberships, capability policies (ADR-011), service-layer authorization, lifecycle + platform endpoints, enriched session view, isolation matrix v1                     | **Delivered** (PR pending) |
